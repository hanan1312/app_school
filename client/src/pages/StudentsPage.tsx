...
type RibbonButtonDef = { label: string; icon: ComponentType<{ size?: number }>; onClick?: () => void; disabled?: boolean };

function RibbonGroup({ caption, buttons }: { caption: string; buttons: RibbonButtonDef[] }) {
  return (
